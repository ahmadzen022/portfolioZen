    ...
    <div>
        ...
        <div class="container">
            ...
            <div class="mb-12 w-full px-4 font-medium text-slate-300 md:w-1/3">
                ...
                <p>zeenajg02_@gmail.com</p>
                <p>Jl. Purbaratu Kp.Ciwasmandi</p>
            ...
            <div class="mb-5 flex items-center justify-center">
                ...
                <!-- Twitter -->
                <a href="https://twitter.com/sandhikagalih" target="_blank" class="mr-3 flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white">
                <svg role="img" width="20" class="fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <title>Twitter</title>
                    <path
            ...
            <p class="text-center text-xs font-medium text-slate-500">
                Dibuat dengan <span class="text-pink-500">❤️</span> oleh <a href="https://instagram.com/zeen_ajg" target="_blank" class="font-bold text-primary">Zeen baik hati</a>, menggunakan
