<template>
  <div class="">
      ...
      <div class="container">
        <div class="flex flex-wrap">
          <div class="w-full self-center px-4 lg:w-1/2">
            ...
            <h2 class="font-medium text-secondary text-lg mb-5 lg:text-2xl">mahasiswa <span class="text-dark">| web developer</span></h2>
            ...
            <a href="#" class="text-base font-semibold text-white bg-primary py-3 px-8 rounded-full hover :shadow-lg hover:opacity-70 transition duration-300 ease-in-out">Hubungi saya</a>
          </div>
          <div class="w-full self-end px-4 lg:w-1/2">
            <div class="relative mt-10 lg:mt-9 lg:right-0">
              <img src="/assets/css/spider-.png" alt="spider" class="max-w-full mx-auto" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="flex flex-wrap">
          <div class="mb-10 w-full px-4 lg:w-1/2">
            ...
            <h2 class="mb-5 max-w-md text-3xl font-bold text-dark dark:text-dark lg:text-4xl">Yuk, belajar</h2>
          ...
          <div class="w-full px-4 lg:w-1/2">
            ...
            <div class="flex items-center">
              ...
              <!-- Instagram -->
              <a
                href="https://instagram.com/zeen_ajg"
                target="_blank"
                class="mr-3 flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white"
              >
    ...
    <section id="project" class="bg-slate-100 pt-36 pb-16 dark:bg-white">
      <div class="container">
        ...
        <div class="flex w-full flex-wrap justify-center px-4 xl:mx-auto xl:w-10/12">
          <div class="mb-12 p-4 md:w-1/2">
            <div class="overflow-hidden rounded-md shadow-md">
              <img src="/assets/css/spider-.png" alt="Landing Page" width="w-full" />
            </div>
          ...
          <div class="mb-12 p-4 md:w-1/2">
            <div class="overflow-hidden rounded-md shadow-md">
              <img src="/assets/css/spider-.png" alt="E-Commerce" width="w-full" />
            </div>
    ...
    <!-- Clients Section End -->
      ...
      <!-- Blog Section Start -->
    <section id="blog" class="bg-slate-100 pt-36 pb-32 dark:bg-white">
      <div class="container">
        <div class="w-full px-4">
          <div class="mx-auto mb-16 max-w-xl text-center">
        ...
        <div class="flex flex-wrap">
          <div class="w-full px-4 lg:w-1/2 xl:w-1/3">
            <div class="mb-10 overflow-hidden rounded-xl bg-white shadow-lg dark:bg-slate-800">
              <img src="/assets/css/spider-.png" alt="Programming" class="w-full" />
              <div class="py-8 px-6">
                <h3>
          ...
          <div class="w-full px-4 lg:w-1/2 xl:w-1/3">
            <div class="mb-10 overflow-hidden rounded-xl bg-white shadow-lg dark:bg-slate-800">
              <img src="/assets/css/spider-.png" alt="Mechanical Keyboard" class="w-full" />
              <div class="py-8 px-6">
                <h3>
